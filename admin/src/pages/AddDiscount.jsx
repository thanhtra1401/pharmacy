    ...
    try {
      ...
      if (response.status === 200) {
        Swal.fire({
          ...
          confirmButtonText: "Áp dụng chương trình khuyến mại",
          cancelButtonText: "Tạo chương trình khuyến mại khác",
        }).then((result) => {
          if (result.isConfirmed) {
            navigate(`/khuyen-mai/ap-dung/${response.data.data.discount.id}`);
          } else {
            reset();
          }
        });
